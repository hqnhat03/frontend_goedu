...
export default function CreateCoursePage() {
    ...
    const form = useForm<FormValues>({
        ...
        defaultValues: {
            ...
            completion_time: 0,
            image_url: "",
            course_materials: [{ id: uuidv4(), link_url: "" }]
        },
    })
    ...
    // 3. Dùng useEffect để fetch levels + subjects
    React.useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                toast.error("Không thể tải dữ liệu trình độ và môn học");
            }
        };
    ...
    async function onSubmit(data: FormValues) {
        ...
        try {
            // Lọc bỏ course_materials rỗng nếu người dùng không nhập url
            const payload = {
                ...data,
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Nhập đầy đủ thông tin để thêm một khóa học lên hệ thống</p>
                    </div>
                </div>
            </div>
                                    ...
                                    fields.map((field, index) => (
                                        <div key={field.id} className="flex gap-4 items-start bg-accent/30 p-3 rounded-lg border border-accent">
                                            <div className="flex-1">
                                                ...
                                                {/* Hidden input for ID validation logic if needed */}
